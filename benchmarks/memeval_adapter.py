...
READER_PROMPT = (
    ...
    "reply exactly: Not mentioned. (2) If the subject checks out and any "
    "fact about it is present, ANSWER from the evidence — count, "
    "compare, or combine facts and dates as needed — even if the answer "
    "is not stated directly or the evidence seems incomplete. Refusing "
    "step 2 is not allowed once step 1 passed. Reply with just the "
    "answer and nothing else: for how-many questions the bare number "
